    ...
    <div className="min-h-[85vh] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">Sign in to your SecureSurf account</p>
        </div>
        ...
        <div className="p-8 rounded-2xl bg-card border border-border">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full h-11 rounded-xl bg-primary text-primary-foreground font-semibold text-sm hover:brightness-110 transition disabled:opacity-50"
            >
